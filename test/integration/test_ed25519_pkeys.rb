...
class TestED25519PKeys < Test::Unit::TestCase
  ...
  def test_in_file_no_password
    Dir.mktmpdir do |dir| dir = "/tmp/test"
      ...
      sh "ssh-keygen -f #{dir}/id_rsa_ed25519 -t ed25519 -N ''"
  ...
  def test_ssh_agent
    Dir.mktmpdir do |dir| dir = "/tmp/test"
      with_agent do
        sh "rm -rf #{dir}/id_rsa_ed25519 #{dir}/id_rsa_ed25519.pub"
        sh "ssh-keygen -f #{dir}/id_rsa_ed25519 -t ed25519 -N 'pwd'"
        set_authorized_key('net_ssh_1',"#{dir}/id_rsa_ed25519.pub")
  ...
  def test_in_file_with_password
    Dir.mktmpdir do |dir| dir = "/tmp/test"
      ...
      assert_raise RuntimeError do
        ret = Net::SSH.start("localhost", "net_ssh_1", {keys: "#{dir}/id_rsa_ed25519", verbose: :debug}) do |ssh|
          ssh.exec! 'echo "hello from:$USER"'
        end
        assert_equal "hello from:net_ssh_1\n", ret
      end
